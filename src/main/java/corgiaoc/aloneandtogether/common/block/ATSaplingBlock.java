...
public class ATSaplingBlock extends BushBlock implements IGrowable {
    ...
    public ATSaplingBlock(Properties properties, TreeSpawner tree, int taskRange) {
        super(properties);
        this.tree = tree;
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.GRASS_BLOCK || state.isIn(Tags.Blocks.DIRT) || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND || block == ATBlocks.OVERGROWN_VOIDSTONE || block == ATBlocks.PHERN_MOSS || block == ATBlocks.ASTRAL_GRASS_BLOCK;
    }
