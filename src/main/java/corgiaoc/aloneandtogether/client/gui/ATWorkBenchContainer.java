package corgiaoc.aloneandtogether.client.gui;
...
public class ATWorkBenchContainer extends WorkbenchContainer {
    private final Block workbench;
    private final IWorldPosCallable worldPos;

    public ATWorkBenchContainer(int id, PlayerInventory playerInv, IWorldPosCallable worldPos, Block workbench) {
