package corgiaoc.aloneandtogether.util.noise.simplex.chunkgen;

public class ChunkFastSimplexStyleNoise {
    ...
    public ChunkFastSimplexStyleNoise(java.util.Random rand) {
        perm = new short[PSIZE];
        permGrad2 = new Grad2[PSIZE];
        permGrad3 = new Grad3[PSIZE];
        short[] source = new short[PSIZE];
